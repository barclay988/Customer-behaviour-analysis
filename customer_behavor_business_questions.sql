...
--Q.2 Which customers use a discount but still spent more than the average purchase amount?
...
--Q.5 Do subscribed customers spend more? compare average spend and total revenue between subscribers and
--non-subscribers.
...
--Q.7 Segment customers into new, returning and loyal based on their total number of previous purchases,
